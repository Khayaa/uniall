            ...
            <div class="row gutters-10 position-relative">
                    ...
                    <div class="aiz-category-menu bg-white rounded  shadow-sm">
                        ...
                        <ul class="list-unstyled categories no-scrollbar py-2 mb-0 text-left">
                            ...
                            <li class="category-nav-element" data-id="11">
                                <a href="https://demo.activeitzone.com/ecommerce/category/home-decoration-appliance"
                                    class="text-truncate text-reset py-2 px-3 d-block">
                                    <img class="cat-image lazyload mr-2 opacity-60"
                                        src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                        data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/Es0gLpejDOBTdBz4CN1BlT12tFTJDjNDXhtEoVEe.jpg"
                                        width="16" alt="Home decoration &amp; Appliance"
                                        onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                ...
                <div class=" col-lg-7 ">
                    <div class="aiz-carousel dots-inside-bottom mobile-img-auto-height slick-initialized slick-slider slick-dotted"
                        data-arrows="true" data-dots="true" data-autoplay="true"><button type="button"
                            class="slick-prev slick-arrow" aria-disabled="false" style=""><i
                                class="las la-angle-left"></i></button>
                        <div class="slick-list draggable">
                            <div class="slick-track"
                                style="opacity: 1; width: 1528px; transform: translate3d(-382px, 0px, 0px);">
                                <div class="slick-slide" data-slick-index="0" aria-hidden="true" style="width: 382px;"
                                ...
                                <div class="slick-slide slick-current slick-active" data-slick-index="1"
                                    aria-hidden="false" style="width: 382px;" role="tabpanel" id="slick-slide01"
                                ...
                                <div class="slick-slide" data-slick-index="2" aria-hidden="true" style="width: 382px;"
                                ...
                                <div class="slick-slide" data-slick-index="3" aria-hidden="true" style="width: 382px;"
                        ...
                        <ul class="slick-dots" style="" role="tablist">
                            <li class="" role="presentation"><button type="button" role="tab"
                                    id="slick-slide-control00" aria-controls="slick-slide00" aria-label="1 of 4"
                                    tabindex="-1">1</button></li>
                            <li role="presentation" class="slick-active"><button type="button" role="tab"
                                    id="slick-slide-control01" aria-controls="slick-slide01" aria-label="2 of 4"
                                    tabindex="0" aria-selected="true">2</button></li>
                            <li class="" role="presentation"><button type="button" role="tab"
                                    id="slick-slide-control02" aria-controls="slick-slide02" aria-label="3 of 4"
                                    tabindex="-1">3</button></li>
                            <li role="presentation" class=""><button type="button" role="tab"
                                    id="slick-slide-control03" aria-controls="slick-slide03" aria-label="4 of 4"
                    ...
                    <ul class="list-unstyled mb-0 row gutters-5">
                        <li class="minw-0 col-4 col-md mt-3">
                            <a href="https://demo.activeitzone.com/ecommerce/category/women-clothing-fashion"
                                ...
                                <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/1MUCmFKsjx73ETkmjx2DYGo3XgKPBDpr36r1b4OY.png"
                                    data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/1MUCmFKsjx73ETkmjx2DYGo3XgKPBDpr36r1b4OY.png"
                                    alt="Women Clothing &amp; Fashion" class="img-fit ls-is-cached lazyloaded"
                                    height="78"
                                    onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg';">
                        ...
                        <li class="minw-0 col-4 col-md mt-3">
                            <a href="https://demo.activeitzone.com/ecommerce/category/mobile-phones"
                                class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/JRAqGXo7vQD0rgAPzJnyFVjWJN4VlGR4eQTNkUKP.png"
                                    data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/JRAqGXo7vQD0rgAPzJnyFVjWJN4VlGR4eQTNkUKP.png"
                                    alt="Mobile Phones" class="img-fit ls-is-cached lazyloaded" height="78"
                                    onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg';">
                                <div class="text-truncate fs-12 fw-600 mt-2 opacity-70">Mobile Phones</div>
                            </a>
                        </li>
                        <li class="minw-0 col-4 col-md mt-3">
                            <a href="https://demo.activeitzone.com/ecommerce/category/women-dress-04vbn"
                                class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/xg4lbDBbbIKJeZGE1xkn3k0g3PVeprNNHmezOwhd.png"
                                    data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/xg4lbDBbbIKJeZGE1xkn3k0g3PVeprNNHmezOwhd.png"
                                    alt="Baby Dresses" class="img-fit ls-is-cached lazyloaded" height="78"
                                    onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg';">
                                <div class="text-truncate fs-12 fw-600 mt-2 opacity-70">Baby Dresses</div>
                            </a>
                        </li>
                        <li class="minw-0 col-4 col-md mt-3">
                            <a href="https://demo.activeitzone.com/ecommerce/category/men-formal-dress-0odnx"
                                class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/lS4LNtTDlbBoEpwsxIieqVTd0WUiUGkj54SuKkPl.png"
                                    data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/lS4LNtTDlbBoEpwsxIieqVTd0WUiUGkj54SuKkPl.png"
                                    alt="Men Formal Dress" class="img-fit ls-is-cached lazyloaded" height="78"
                                    onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg';">
                                <div class="text-truncate fs-12 fw-600 mt-2 opacity-70">Men Formal Dress</div>
                            </a>
                        </li>
                        <li class="minw-0 col-4 col-md mt-3">
                            <a href="https://demo.activeitzone.com/ecommerce/category/doll-niia5"
                                class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/YxqVTyAxbqDphgEHg8pSBiQ7Z6RVAZgrMMRKp4iX.png"
                                    data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/YxqVTyAxbqDphgEHg8pSBiQ7Z6RVAZgrMMRKp4iX.png"
                                    alt="Kids &amp; Toy" class="img-fit ls-is-cached lazyloaded" height="78"
                                    onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg';">
                                <div class="text-truncate fs-12 fw-600 mt-2 opacity-70">Kids &amp; Toy</div>
                            </a>
                        </li>
                        <li class="minw-0 col-4 col-md mt-3">
                            <a href="https://demo.activeitzone.com/ecommerce/category/tools-vgs3d"
                                class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/0xydX0EqPmMjchMD9wc337vlHbZk9BQLIPlfisEp.png"
                                    data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/0xydX0EqPmMjchMD9wc337vlHbZk9BQLIPlfisEp.png"
                                    alt="Tools" class="img-fit ls-is-cached lazyloaded" height="78"
                                    onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg';">
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="c-scrollbar-light overflow-auto h-lg-400px p-2 bg-primary rounded-bottom">
                            <div class="gutters-5 lg-no-gutters row row-cols-2 row-cols-lg-1">
                                <div class="col mb-2">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/Philips-Rice-Cooker-06L-4BWjg"
                                        class="d-block p-2 text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center">
                                            <div class="col-xxl">
                                                <div class="img">
                                                    <img class="img-fit h-140px h-lg-80px ls-is-cached lazyloaded"
                                                        src="https://demo.activeitzone.com/ecommerce/public/uploads/all/5DpZmEosn1JKGBEv7LnmKaY2z3oN9TIlj6zSgSCs.jpg"
                                ...
                                <div class="col mb-2">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/adidas-mens-originals-poly-tape-shorts-en9ka"
                                        class="d-block p-2 text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center">
                                            <div class="col-xxl">
                                                <div class="img">
                                                    <img class="img-fit h-140px h-lg-80px ls-is-cached lazyloaded"
                                                        src="https://demo.activeitzone.com/ecommerce/public/uploads/all/u1DDNkgW9HCKqNHOYURJY6dJaqwiSwBBQj8S0jLH.png"
                                ...
                                <div class="col mb-2">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/adidas-womens-cropped-slim-polyester-shorts-jvdi7"
                                        class="d-block p-2 text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center">
                                            <div class="col-xxl">
                                                <div class="img">
                                                    <img class="img-fit h-140px h-lg-80px ls-is-cached lazyloaded"
                                                        src="https://demo.activeitzone.com/ecommerce/public/uploads/all/8LmfSZEGCktshcYjefNylyAHRdFwPqkKz7hwVG9R.png"
                                ...
                                <div class="col mb-2">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/nike-men-mercurial-superfly-7-elite-firm-ground-football-shoe-zlwgn"
                                        class="d-block p-2 text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center">
                                            <div class="col-xxl">
                                                <div class="img">
                                                    <img class="img-fit h-140px h-lg-80px ls-is-cached lazyloaded"
                                                        src="https://demo.activeitzone.com/ecommerce/public/uploads/all/LfCYkZUyEVnUSjqjznaA6MVuLETNLDkaTMnCud9F.png"
                                ...
                                <div class="col mb-2">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/FIFA-22-Standard---PC-Online-Game-Code-22545"
                                        class="d-block p-2 text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center">
                                            <div class="col-xxl">
                                                <div class="img">
                                                    <img class="img-fit h-140px h-lg-80px ls-is-cached lazyloaded"
                                                        src="https://demo.activeitzone.com/ecommerce/public/uploads/all/4gmGnYIZhgatZRJsxrhXVW2qO0aoLLdZT8U6qOQE.png"
                                ...
                                <div class="col mb-2">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/apple-iphone-14-pro-128gb-512gb-deep-purple-unlocked"
                                        ...
                                        <div class="row gutters-5 align-items-center">
                                            <div class="col-xxl">
                                                <div class="img">
                                                    <img class="img-fit h-140px h-lg-80px lazyloaded"
                                                        src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
        ...
        <div class="row gutters-10">
            <div class="col-xl col-md-6">
                <div class="mb-3 mb-lg-0">
                    <a href="https://demo.activeitzone.com/ecommerce/flash-deals" class="d-block text-reset">
                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                            data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/ftvjCr0dQVT8NRMN9CfRF59Lft5EowYR0jK9ErOD.png"
                            alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                    </a>
                </div>
            </div>
            <div class="col-xl col-md-6">
                <div class="mb-3 mb-lg-0">
                    <a href="https://demo.activeitzone.com/ecommerce/flash-deals" class="d-block text-reset">
                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                            data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/0tTAxWgBlgFePPIsVPr0mVsZZ1Ri5Fx5eFBshiqQ.png"
                            alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                    </a>
                </div>
            </div>
            <div class="col-xl col-md-6">
                <div class="mb-3 mb-lg-0">
                    <a href="https://demo.activeitzone.com/ecommerce/flash-deals" class="d-block text-reset">
                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                            data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/r3RsqaoHCK1hdSDx6atacmch35DA0tAOb6NvFeiy.png"
                            alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                    </a>
                </div>
            </div>
            ...
            <div class="container">
                <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                    ...
                    <div class="aiz-carousel gutters-10 half-outside-arrow slick-initialized slick-slider" data-items="6"
                        ...
                        data-arrows="true"><button type="button" class="slick-prev slick-arrow slick-disabled"
                            aria-disabled="true" style=""><i class="las la-angle-left"></i></button>
                        <div class="slick-list draggable">
                            <div class="slick-track"
                    ...
                    <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5"
                        ...
                        <div class="carousel-box">
                            <div
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/apple-iphone-14-pro-128gb-512gb-deep-purple-unlocked"
                                            class="d-block text-reset">Apple iPhone 14 Pro , 128GB, 512GB, Deep
                                            Purple- Unlocked</a>
                                    </h3>
                        ...
                        <div class="carousel-box">
                            <div
                                class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
                                <div class="position-relative">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/corsair-k60-rgb-pro-mechanical-gaming-keyboard-cherry-mechanical-keyswitches-durable-aluminumframe-customizable-per-key-rgb-backlighting-black0"
                                        class="d-block">
                                        <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                            src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/corsair-k60-rgb-pro-mechanical-gaming-keyboard-cherry-mechanical-keyswitches-durable-aluminumframe-customizable-per-key-rgb-backlighting-black0"
                                            class="d-block text-reset">Corsair K60 RGB Pro Mechanical Gaming
                                            Keyboard - CHERRY Mechanical Keyswitches - Durable AluminumFrame -
                                            Customizable Per-Key RGB Backlighting, Black</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                        ...
                        <div class="carousel-box">
                            <div
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/FIFA-22-Standard---PC-Online-Game-Code-22545"
                                            class="d-block text-reset">FIFA 22 Standard - PC [Online Game
                                            Code]</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                        ...
                        <div class="carousel-box">
                            <div
                                class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
                                <div class="position-relative">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/Adobe-Premiere-Elements-2022--PCMac-Disc-12646"
                                        class="d-block">
                                        <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                            src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/Adobe-Premiere-Elements-2022--PCMac-Disc-12646"
                                            class="d-block text-reset">Adobe Premiere Elements 2022 | PC/Mac
                                            Disc</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                        ...
                        <div class="carousel-box">
                            <div
                                class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
                                <div class="position-relative">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/microsoft-365-personal--12-month-subscription-1-person-premium-office-apps-68431"
                                        class="d-block">
                                        <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                            src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/microsoft-365-personal--12-month-subscription-1-person-premium-office-apps-68431"
                                            class="d-block text-reset">Microsoft 365 Personal | 12-Month
                                            Subscription, 1 person| Premium Office Apps</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                                        <span class="fw-700 float-right">0</span>
                        ...
                        <div class="carousel-box">
                            <div
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/analog-black-dial-mens-watch-32-bk-ck"
                                            class="d-block text-reset">Fossil Men&#039;s Grant Stainless Steel
                        ...
                        <div class="carousel-box">
                            <div
                                class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
                                <div class="position-relative">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/baby-girls-cotton-dress-cardigan-and-shoe-set"
                                        class="d-block">
                                        <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                            src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/baby-girls-cotton-dress-cardigan-and-shoe-set"
                                            class="d-block text-reset">Gerber Unisex-Baby Onesies Bodysuit Multi
                                            Pack</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                        ...
                        <div class="carousel-box">
                            <div
                                class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
                                <div class="position-relative">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/mens-one-and-only-textured-short-sleeve-button-up-qmn5g"
                                        class="d-block">
                                        <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                            src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <div class="rating rating-sm mt-1">
                                        <i class='las la-star active'></i><i class='las la-star active'></i><i
                                            class='las la-star active'></i><i class='las la-star'></i><i
                                            class='las la-star'></i>
                                    </div>
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/mens-one-and-only-textured-short-sleeve-button-up-qmn5g"
                                            class="d-block text-reset">Gildan Men&#039;s Crew T-Shirts,
                                            Multipack</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                        ...
                        <div class="carousel-box">
                            <div
                                ...
                                <div class="position-relative">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/gopune-mens-athletic-tracksuit-full-zip-warm-jogging-sweat-suits-mrcnp"
                                        class="d-block">
                                        <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                            src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/gopune-mens-athletic-tracksuit-full-zip-warm-jogging-sweat-suits-mrcnp"
                                            class="d-block text-reset">Hgvoetty Unisex 3D Print Shirts Colorful
                                            Space Graphic Tees for Men Women Teens</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                                        <span class="fw-700 float-right">0</span>
                        ...
                        <div class="carousel-box">
                            <div
                                ...
                                <div class="position-relative">
                                    <a href="https://demo.activeitzone.com/ecommerce/product/udalyn-rhinestone-bridesmaid-jewelry-sets-for-women-7i3tx"
                                        class="d-block">
                                        <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                            src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/udalyn-rhinestone-bridesmaid-jewelry-sets-for-women-7i3tx"
                                            class="d-block text-reset">Gillette Sensor3 Comfort Disposable Razors
                                            for Men, 12 Count, Water-Activated Comfortgel Technology</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                                        <span class="fw-700 float-right">0</span>
                        ...
                        <div class="carousel-box">
                            <div
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/mens-machine-stainless-steel-quartz-chronograph-watch-2gns4"
                                            class="d-block text-reset">Men&#039;s Machine Stainless Steel Quartz
                                            Chronograph Watch</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
                        ...
                        <div class="carousel-box">
                            <div
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                        <a href="https://demo.activeitzone.com/ecommerce/product/airpods-max-hjeer"
                                            class="d-block text-reset">Apple iPhone 13 Pro Max (128 GB, Alpine
                                            Green)</a>
                                    </h3>
                                    <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border">
                                        Club Point:
            ...
            <div class="row gutters-10">
                <div class="col-xl col-md-6">
                    <div class="mb-3 mb-lg-0">
                        <a href="https://demo.activeitzone.com/ecommerce/blog" class="d-block text-reset">
                            <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                                data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/pd8obnWJJlk4IomqDXV12MrnHTMRYJayCoGc6KBy.png"
                                alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                        </a>
                    </div>
                </div>
                <div class="col-xl col-md-6">
                    <div class="mb-3 mb-lg-0">
                        <a href="https://demo.activeitzone.com/ecommerce/blog" class="d-block text-reset">
                            <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                                data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/hAxSFAEl2aa3p2aEiZmEWOUAZWxCQ5k0CKt7rjxn.png"
                                alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                        </a>
                    </div>
                </div>
                <div class="col-xl col-md-6">
                    <div class="mb-3 mb-lg-0">
                        <a href="https://demo.activeitzone.com/ecommerce/blog" class="d-block text-reset">
                            <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                                data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/xPUoV4MFG1ld4uIeB95YblBgdvwfo3qSCn5V8PBo.png"
                                alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                        </a>
                    </div>
                </div>
    ...
    {{-- <section class="mb-4">
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">Classified
                            Ads</span>
                    </h3>
                    <a href="https://demo.activeitzone.com/ecommerce/customer-products"
                ...
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5"
                    ...
                    <div class="carousel-box">
                        <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                            <div class="position-relative">
                                <a href="https://demo.activeitzone.com/ecommerce/customer-product/canon-eos-1500drebel-t7-dslr-camera-with-ef-s-18-55-mm-f35-56-is-ii-lens-rkdnw"
                                    class="d-block">
                                    <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                        src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                    <a href="https://demo.activeitzone.com/ecommerce/customer-product/canon-eos-1500drebel-t7-dslr-camera-with-ef-s-18-55-mm-f35-56-is-ii-lens-rkdnw"
                                        class="d-block text-reset">Canon EOS 1500D/Rebel T7 DSLR Camera with EF-S
                                        18-55 mm f/3.5-5.6 is II Lens</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-box">
                        <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                            <div class="position-relative">
                                <a href="https://demo.activeitzone.com/ecommerce/customer-product/sony-bravia-108-cm-43-inches-full-hd-smart-led-tv-kdl-ok3mt"
                                    class="d-block">
                                    <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                        src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                    <a href="https://demo.activeitzone.com/ecommerce/customer-product/sony-bravia-108-cm-43-inches-full-hd-smart-led-tv-kdl-ok3mt"
                                        class="d-block text-reset">Sony Bravia 108 cm (43 inches) Full HD Smart
                                        LED TV KDL</a>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="carousel-box">
                        <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                            <div class="position-relative">
                                <a href="https://demo.activeitzone.com/ecommerce/customer-product/sony-ht-s20r-51ch-dolby-digital-soundbar-sv3n9"
                                    class="d-block">
                                    <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                        src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                    <a href="https://demo.activeitzone.com/ecommerce/customer-product/sony-ht-s20r-51ch-dolby-digital-soundbar-sv3n9"
                                        class="d-block text-reset">Sony HT-S20R 5.1ch Dolby Digital Soundbar</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-box">
                        <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                            <div class="position-relative">
                                <a href="https://demo.activeitzone.com/ecommerce/customer-product/mi-smart-router-4c-300-mbps-with-4-high-performance-antenna--app-control-wy3kx"
                                    class="d-block">
                                    <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                        src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                    <a href="https://demo.activeitzone.com/ecommerce/customer-product/mi-smart-router-4c-300-mbps-with-4-high-performance-antenna--app-control-wy3kx"
                                        class="d-block text-reset">Mi Smart Router 4C, 300 Mbps with 4
                                        high-Performance Antenna &amp; App Control</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-box">
                        <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                            <div class="position-relative">
                                <a href="https://demo.activeitzone.com/ecommerce/customer-product/canon-pixma-ts3320-black-works-with-alexa-87ole"
                                    class="d-block">
                                    <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                        src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                    <a href="https://demo.activeitzone.com/ecommerce/customer-product/canon-pixma-ts3320-black-works-with-alexa-87ole"
                                        class="d-block text-reset">Canon Pixma TS3320 Black, Works with Alexa</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-box">
                        <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                            <div class="position-relative">
                                <a href="https://demo.activeitzone.com/ecommerce/customer-product/apple-watch-series-6-gps-40mm---gold-aluminum-case-with-pink-sand-sport-band-2rgs4"
                                    class="d-block">
                                    <img class="img-fit lazyload mx-auto h-140px h-md-210px"
                                        src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                            ...
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                    <a href="https://demo.activeitzone.com/ecommerce/customer-product/apple-watch-series-6-gps-40mm---gold-aluminum-case-with-pink-sand-sport-band-2rgs4"
                                        class="d-block text-reset">Apple Watch Series 6 (GPS, 40mm) - Gold
                                        Aluminum Case with Pink Sand Sport Band</a>
                                </h3>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row gutters-10">
                <div class="col-xl col-md-6">
                    <div class="mb-3 mb-lg-0">
                        <a href="https://demo.activeitzone.com/ecommerce/flash-deals" class="d-block text-reset">
                            <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                                data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/X4hJOrT209ZqqGIr4TSitU30cIjbxNRD1du4XTIR.png"
                                alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                        </a>
                    </div>
                </div>
                <div class="col-xl col-md-6">
                    <div class="mb-3 mb-lg-0">
                        <a href="https://demo.activeitzone.com/ecommerce/flash-deals" class="d-block text-reset">
                            <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                                data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/jsFxrAwQdU5YZ8P98BbW8Ec4BgebBBkKaDtogKm1.png"
                                alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                        </a>
                    </div>
                </div>
                <div class="col-xl col-md-6">
                    <div class="mb-3 mb-lg-0">
                        <a href="https://demo.activeitzone.com/ecommerce/flash-deals" class="d-block text-reset">
                            <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder-rect.jpg"
                                data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/oxv93ppI31VAVmCnQBfb8in0TDipFr2nFIZ1ZWQO.png"
                                alt="Active eCommerce CMS promo" class="img-fluid lazyload w-100">
                        </a>
                    </div>
                </div>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/1MUCmFKsjx73ETkmjx2DYGo3XgKPBDpr36r1b4OY.png"
                                            alt="Women Clothing &amp; Fashion" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Women Clothing
                                            &amp; Fashion</div>
                                    </div>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Men Clothing &amp; Fashion" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Men Clothing &amp;
                                            Fashion</div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Computer &amp; Accessories" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Computer &amp;
                                            Accessories</div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Automobile &amp; Motorcycle" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Automobile &amp;
                                            Motorcycle</div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Kids &amp; toy" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Kids &amp; toy
                                        </div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Sports &amp; outdoor" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Sports &amp;
                                            outdoor</div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Jewelry &amp; Watches" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Jewelry &amp;
                                            Watches</div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Beauty, Health &amp; Hair" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Beauty, Health
                                            &amp; Hair</div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Home Improvement &amp; Tools" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Home Improvement
                                            &amp; Tools</div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-3 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            ...
                                            alt="Home decoration &amp; Appliance" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-7">
                                        <div class="text-truncat-2 pl-3 fs-14 fw-600 text-left">Home decoration
                                            &amp; Appliance</div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
                ...
                <div class="col-lg-6">
                    <div class="d-flex mb-3 align-items-baseline border-bottom">
                        ...
                        <a href="https://demo.activeitzone.com/ecommerce/brands"
                            class="ml-auto mr-0 btn btn-primary btn-sm shadow-md">View All Brands</a>
                    </div>
                    <div class="row gutters-5">
                        <div class="col-sm-6">
                            <a href="https://demo.activeitzone.com/ecommerce/brand/ford"
                                class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2">
                                <div class="row align-items-center no-gutters">
                                    <div class="col-4 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/CVo1G2QVpVtSoZlmCvC0l4hL9WIiWLlTQf6XclMC.jpg"
                                            alt="Ford" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-6">
                        ...
                        <div class="col-sm-6">
                            <a href="https://demo.activeitzone.com/ecommerce/brand/mercedes-benz"
                                class="bg-white border d-block text-reset rounded p-2 hov-shadow-md mb-2">
                                <div class="row align-items-center no-gutters">
                                    <div class="col-4 text-center">
                                        <img src="https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg"
                                            data-src="https://demo.activeitzone.com/ecommerce/public/uploads/all/rCfpiBkUtiOz8Ipakex02EA8uNYXGySvQWH9phRx.jpg"
                                            alt="Mercedes-Benz" class="img-fluid img lazyload h-60px"
                                            onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/placeholder.jpg';">
                                    </div>
                                    <div class="col-6">
                                        <div class="text-truncate-2 pl-3 fs-14 fw-600 text-left">Mercedes-Benz
                                        </div>
                                    </div>
                                    <div class="col-2 text-center">
                                        <i class="la la-angle-right text-primary"></i>
